...
{
    public class DaiHeadPose : PredefinedBase, IDisposable
    {
        ...
        protected override void ProcessResults()
        {
            ...
            else
            {
                ...
                if (headPoseYaw != 0 && headPosePitch != 0 && headPoseRoll != 0)
                {
                    ...
                    HeadPoseChanged?.Invoke(this, new HeadPoseChangedArgs()
                    {
                        HeadPitch = headPosePitch,
                        HeadRoll = headPoseRoll,
                        HeadYaw = headPoseYaw,
                        OldHeadRoll = oldHeadPoseRoll,
                        OldHeadPitch = oldHeadPosePitch,
                        OldHeadYaw = oldHeadPoseYaw,
    ...
    public class HeadPoseChangedArgs : EventArgs
    {
        ...
        public float OldHeadRoll { get; set; }
        public float OldHeadYaw { get; set; }
        public float OldHeadPitch { get; set; }
